...
class Home extends Component {
    ...
    onClickProgram = (event, programName) => {
      var {planList} = this.state

      //planlist = call Xiangpeng's function with program name as input
      planList = ["Co op Plan I", "Traditional plan",]
      
      this.setState({planList : planList, selectedProgram: programName})
    }
